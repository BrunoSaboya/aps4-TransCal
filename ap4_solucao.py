from funcoesTermosol import importa, internas, plota, geraSaida, rigidez, apoio, deformacao, tensao, internas, novos_nos
import numpy as np
...
def solver():
    ...
    # F = Matriz com a posição das forças e os módulospip install xlrd==2.0.1
